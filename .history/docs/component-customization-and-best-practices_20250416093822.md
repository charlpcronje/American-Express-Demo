...
- [x] **README.md:** Project overview, architecture, main components, customization guide.
- [x] **assets-and-testdata.md:** Where to put images/test data, referencing assets.
- [x] **build-process.md:** How to build, serve, and deploy the project.
- [x] **troubleshooting.md:** Common issues and debugging tips.
